...
void ItemManager::generateItem(IDisplayObject *render_node)
{
...
void ItemManager::testCollision(IDisplayObject * render_node,IDisplayObject *pCollisionTarget)
{
    if (!mItemArray.empty()) {
        for (int i = 0; i < mItemArray.size(); i++) {
            auto pItem = mItemArray.at(i);
...
void ItemManager::update(float dt, IDisplayObject *render_node, IDisplayObject *pCollisionTarget)
{
