...
public:
    ...
    void onCollision(IDisplayObject * render_node,IDisplayObject *pCollisionTarget);
    ...
    void addCollisionEffect(IDisplayObject * render_node,IDisplayObject *pCollisionTarget);
