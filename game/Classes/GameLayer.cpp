...
void GameLayer::createGameScreen () {
    ...
    _background->addChild(repeat, kBackgroud);
    ...
    _jamAnimate->retain();
    _gameBatchNode->addChild(_jam, kBackgroud);
    ...
    this->addChild(_mainMenu, kForegroud);
    ...
    this->addChild(_tutorialLabel, kForegroud);
    _tutorialLabel->setVisible(false);
